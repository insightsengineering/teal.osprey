...
Source:
[`DESCRIPTION`](https://github.com/insightsengineering/teal.osprey/blob/v0.5.0rc/DESCRIPTION)

Qi N, Kaledkowski D, Liao C, Li L, Pagacz K (2026). *teal.osprey: 'teal'
Modules for TLG Functions in Osprey*. R package version 0.5.0,
...
0.5.0}, url = {https://insightsengineering.github.io/teal.osprey/}, }
