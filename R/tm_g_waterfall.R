...
tm_g_waterfall <- function(label,
  ...
  chcekmate::assert_class(bar_paramcd, classes = "choices_selected")
  chcekmate::assert_class(bar_var, classes = "choices_selected")
  chcekmate::assert_class(bar_color_var, classes = "choices_selected")
  chcekmate::assert_class(sort_var, classes = "choices_selected")
  chcekmate::assert_class(anno_txt_var_sl, classes = "choices_selected")
  chcekmate::assert_class(anno_txt_paramcd_rs, classes = "choices_selected")
  chcekmate::assert_class(facet_var, classes = "choices_selected")
  chcekmate::assert_class(add_label_var_sl, classes = "choices_selected")
  chcekmate::assert_class(add_label_paramcd_rs, classes = "choices_selected")
